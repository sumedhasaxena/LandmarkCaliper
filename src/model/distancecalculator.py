...
class DistanceCalculator(ABC):
    ...
    @beartype
    def init(self, image : mpipe.Image, landmark_result: HandLandmarkerResult) -> None:
    ...
    def _calculate_landmark_distances(self) -> None:
        ...
        logger.info(f'calculated landmark distances and updated hand measurements. total: {len(self.landmark_distance)}' )
